...
<div class="card">
 ...
 <img src="https://sportshub.cbsistatic.com/i/r/2022/06/10/139ab78f-d458-4a66-9179-0312585bfbfa/thumbnail/1200x675/f403faf31c079bf1f1206f8e8b96660e/tastumcbs.jpg">
  ...
  <button id="duplicate">Replicate</button>

  <button id="bg-color">Background Color</button>
  <button onclick="myFunction2()"> Change Heading</button>
  <button id="delete()">Remove card</button>
  );
}
